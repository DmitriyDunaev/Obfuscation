    ...
    public static class Traversal
    {
        ...
        private static BasicBlock GetDirectPredecessor(BasicBlock actual)
        {
            ...
            foreach (BasicBlock bb in actual.getPredecessors)
            {
                ...
                {
                    case 1:
                        if (bb.Instructions.Last().statementType != Objects.Common.StatementType.UnconditionalJump)
                            return bb;
                        break;
        ...
        private static BasicBlock GetDirectSuccessor(BasicBlock actual)
        {
            ...
            switch (actual.getSuccessors.Count)
            {
                case 1:
                    ...
                    if (actual.Instructions.Last().statementType != Objects.Common.StatementType.UnconditionalJump)
        ...
        public static void ReorderBasicBlocks (Function func)
        {
            ...
            foreach (BasicBlock bb in func.BasicBlocks)
            {
                ...
                if (succlist != null && !succlist.First().Equals(GetDirectSuccessor(bb)))
                    throw new TraversalException("The direct successor should be the first in its list.");
                ...
                if (predlist != null && !predlist.Last().Equals(GetDirectPredecessor(bb)))
                    throw new TraversalException("The direct predecessor should be the last in its list.");
            ...
            if (func.BasicBlocks.Count != CountAll())
                throw new TraversalException("Not all basic blocks are in the lists...");
